...
Route.post('/admin/grades/uploadGrades', 'Admin/GradeController.uploadGrades').validator('StudentGradeUpload')
...
Route.post('/admin/studentinfo/uploadStudentInfo', 'Admin/StudentInfoController.uploadStudentInfo').validator('StudentInfoUpload') 
